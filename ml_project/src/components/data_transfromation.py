...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info(f'Appling preprcessing object on training dataframe and testing datafreme')
            input_fearture_train_arr=preprocessing_obj.fit_transform(input_feature_train_df)
